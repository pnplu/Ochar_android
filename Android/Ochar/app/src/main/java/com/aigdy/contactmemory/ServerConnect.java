...
/**
 * Created by aigdy on 10/17/2016 AD.
 */
public class ServerConnect {
    public final static String http = "https://";
    public final static String ip = "www.graffstudio.in.th"; //ถ้าเอาลง host จริงจะใช้เป็น "www.xxx.com"
    public final static String dir = "android";
